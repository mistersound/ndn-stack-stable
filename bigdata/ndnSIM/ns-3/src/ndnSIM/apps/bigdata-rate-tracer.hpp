...
#ifndef CCNX_BIGDATA_RATE_TRACER_H
#define CCNX_BIGDATA_RATE_TRACER_H
 ...
 */
class BigDataRateTracer : public L3Tracer {
public:
  /**
   ...
   */
  BigDataRateTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  BigDataRateTracer(shared_ptr<std::ostream> os, const std::string& node);

  /**
   * @brief Destructor
   */
  virtual ~BigDataRateTracer();
